...
\begin{enumerate}
    ...
    \end{proof}
    \item[v)] \textit{Simple roots are linearly independent.}
    For clarity of reading, I have moved the proof to the notes for the next lecture since we only managed to write the first few lines in this lecture.
    %\begin{proof}
