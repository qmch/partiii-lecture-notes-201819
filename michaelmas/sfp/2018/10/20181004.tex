...
\end{itemize}
Prof. Dorey has also provided his own handwritten notes, which I will be typing up and supplementing with lecture material here.
...
\begin{defn}
A group $G$ is called \term{abelian} if the multiplication law is commutative ($\forall g_1,g_2\in G, g_1g_2=g_2g_1$). Otherwise, it is called non-abelian.
\end{defn}
