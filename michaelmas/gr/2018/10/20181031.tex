...
\end{equation}
This is an example of a \term{conformal transformation}, in this case of the standard Minkowski metric. A conformal transformation takes our original metric $g_{ab}$ to a new metric $\hat g_{ab}=\Omega^2 g_{ab}$ where $\Omega(t,x,y,z)$ is any (real-valued, smooth) function of the coordinates.%
...
To answer this question, we write down the geodesic equation,
\begin{equation}
