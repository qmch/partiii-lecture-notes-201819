...
\begin{defn}
A spacetime $(M,g)$ is \term{spherically symmetric} if it possesses the same group of isometries as the round two-sphere $d\Omega_2^2$. Important remark-- there are spacetimes such as Taub-NUT spacetime which enjoy $SO(3)$ symmetry but are \emph{not} spherically symmetric.
\end{defn}
