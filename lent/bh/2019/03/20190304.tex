...
\end{equation}
This is just Maxwell's equations and the Bianchi identity on the field strength tensor. The \term{Hodge dual} (Hodge star) of a $p$-form $\omega_p$ is a $d-p$ form with components defined by
\begin{equation}
