...
\begin{defn}
    The \term{Kerr solution} is the Kerr-Newman solution with no charge, $Q=P=0$. We can further define 
    \begin{equation}
...
\end{equation}
This calculation tells us there's a boundary known as the \term{ergosphere} defined by $r=M+\sqrt{M^2-a^2 \cos^2 \theta}$ bounding a region known as the \term{ergoregion}, some of which lies outside the black hole. Notice that the sign of $g_{tt}$ flips sign within the ergoregion, even though this region lies outside the event horizon.%
