...
We see that the old $\Lambda\to\infty$ divergence appears here as a $1/\epsilon$ pole in the self-energy. In order to make this contribution converge, we must add a counterterm $\frac{\delta m^2}{2} \phi^2$. The first thing we might think to do is the \term{minimal subtraction} (MS) scheme,
\begin{equation}
