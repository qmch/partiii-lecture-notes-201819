...
\textbf{Q:} How much information can Bob gain about $X$ through his measurement? It is simply the mutual information $I(X:Y)$. To get the maximum possible information, we ought to maximize
\begin{equation}
