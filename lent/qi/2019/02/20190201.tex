...
\end{align}
One can then show that $\rho_A \geq 0$ (is positive semi-definite) and $\Tr \rho_A=1$, so $\rho_A$ is in fact a density matrix. We call $\rho_A$ the \term{reduced density matrix}, or a reduced state.
